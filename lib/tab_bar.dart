...
import 'package:untitled2/views/customer/customer_page.dart';
import 'package:untitled2/views/order/order_page.dart';
import 'package:untitled2/views/product/products_page.dart';
import 'package:untitled2/views/setts.dart';
...
class _TabBars extends State<TabBars> {
  ...
  _TabBars({required this.parent}) {
    _widgetOptions.addAll([
      ...
      Container(
        child: SettingsFileBased(parent: parent!),
      )
    ]);
  }
